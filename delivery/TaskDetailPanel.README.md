# TaskDetailPanel 鈥?UI delivery package (for YC-Ego)

## Import
1. Import `TaskDetailPanel.unitypackage` into the YC-Ego project (exported with .meta -> GUID-faithful).
...
## How to bind (read only `TaskDetailPanel.binding.json` + the prefab; never reference this project)
...
Human-readable element table: `TaskDetailPanel.binding.md`.
