# ScanPanel â€” UI delivery package (for YC-Ego)

## Import
1. Import `ScanPanel.unitypackage` into the YC-Ego project (exported with .meta -> GUID-faithful).
...
## How to bind (read only `ScanPanel.binding.json` + the prefab; never reference this project)
...
Human-readable element table: `ScanPanel.binding.md`.
