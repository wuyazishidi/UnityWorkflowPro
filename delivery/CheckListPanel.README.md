# CheckListPanel 鈥?UI delivery package (for YC-Ego)

## Import
1. Import `CheckListPanel.unitypackage` into the YC-Ego project (exported with .meta -> GUID-faithful).
...
## How to bind (read only `CheckListPanel.binding.json` + the prefab; never reference this project)
...
Human-readable element table: `CheckListPanel.binding.md`.
